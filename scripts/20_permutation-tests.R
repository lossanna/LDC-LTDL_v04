...
all.matched.diversity <- read_csv("data/versions-from-R/18_shannon-diversity_all-models.csv")
all.matched.invasive <- read_csv("data/versions-from-R/19_invasive-cover_all-models.csv")
geoindicators <- read_csv("data/versions-from-R/14.3_geoindicators.csv")


# Data wrangling ----------------------------------------------------------

# Combine diversity & invasive species df
all.matched <- all.matched.diversity |> 
  left_join(all.matched.invasive)

# Functional group cover cols from geoindicators
funct.group <- geoindicators |> 
...
model01.matched <- all.matched |> 
  filter(Model == 1) |> 
  select(LDCpointID, PrimaryKey, trt_control, Shannon, InvasiveCover) |> 
...
model01.matched <- model01.matched |> 
  mutate(indicators = 
           case_when(
             ...
             indicators == "InvasiveCover" ~ "Invasive"
           )) |> 
...
p_values01 # p = 0.014 for shannon
...
#   Invasive
model01.invasive <- model01.perm |> 
  filter(indicators == "Invasive") |> 
  ggplot(aes(x = mean_diff)) +
  geom_histogram(fill = "lightblue2", color = "black") +
  geom_vline(xintercept = model01.diff$obs_diff[model01.diff$indicators == "Invasive"],
             color = "red", linetype = "dashed", linewidth = 1) +
  labs(x = "Difference in means",
       y = "Frequency",
       title = "Invasive") +
...
grid.arrange(
  ...
  model01.shannon, model01.invasive,
  layout_matrix = rbind(
    c(1, 1, 1, 1, 1, 1),
    c(NA, 2, 2, 3, 3, NA),
    c(4, 4, 5, 5, 6, 6),
...
#   Invasive
model02.invasive <- model02.perm |> 
  filter(indicators == "Invasive") |> 
  ggplot(aes(x = mean_diff)) +
  geom_histogram(fill = "lightblue2", color = "black") +
  geom_vline(xintercept = model02.diff$obs_diff[model02.diff$indicators == "Invasive"],
             color = "red", linetype = "dashed", linewidth = 1) +
  labs(x = "Difference in means",
       y = "Frequency",
       title = "Invasive") +
...
grid.arrange(
  ...
  model02.shannon, model02.invasive,
  layout_matrix = rbind(
    c(1, 1, 1, 1, 1, 1),
    c(NA, 2, 2, 3, 3, NA),
    c(4, 4, 5, 5, 6, 6),
...
#   Invasive
model03.invasive <- model03.perm |> 
  filter(indicators == "Invasive") |> 
  ggplot(aes(x = mean_diff)) +
  geom_histogram(fill = "lightblue2", color = "black") +
  geom_vline(xintercept = model03.diff$obs_diff[model03.diff$indicators == "Invasive"],
             color = "red", linetype = "dashed", linewidth = 1) +
  labs(x = "Difference in means",
       y = "Frequency",
       title = "Invasive") +
...
grid.arrange(
  ...
  model03.shannon, model03.invasive,
  layout_matrix = rbind(
    c(1, 1, 1, 1, 1, 1),
    c(NA, 2, 2, 3, 3, NA),
    c(4, 4, 5, 5, 6, 6),
...
#   Invasive
model04.invasive <- model04.perm |> 
  filter(indicators == "Invasive") |> 
  ggplot(aes(x = mean_diff)) +
  geom_histogram(fill = "lightblue2", color = "black") +
  geom_vline(xintercept = model04.diff$obs_diff[model04.diff$indicators == "Invasive"],
             color = "red", linetype = "dashed", linewidth = 1) +
  labs(x = "Difference in means",
       y = "Frequency",
       title = "Invasive") +
...
grid.arrange(
  ...
  model04.shannon, model04.invasive,
  layout_matrix = rbind(
    c(1, 1, 1, 1, 1, 1),
    c(NA, 2, 2, 3, 3, NA),
    c(4, 4, 5, 5, 6, 6),
...
#   Invasive
model05.invasive <- model05.perm |> 
  filter(indicators == "Invasive") |> 
  ggplot(aes(x = mean_diff)) +
  geom_histogram(fill = "lightblue2", color = "black") +
  geom_vline(xintercept = model05.diff$obs_diff[model05.diff$indicators == "Invasive"],
             color = "red", linetype = "dashed", linewidth = 1) +
  labs(x = "Difference in means",
       y = "Frequency",
       title = "Invasive") +
...
grid.arrange(
  ...
  model05.shannon, model05.invasive,
  layout_matrix = rbind(
    c(1, 1, 1, 1, 1, 1),
    c(NA, 2, 2, 3, 3, NA),
    c(4, 4, 5, 5, 6, 6),
...
p_values06 <- model06.perm |>
  ...
  group_by(indicators) |>
  summarize(p_value = mean(abs(mean_diff) >= abs(obs_diff[1])))
p_values06 # p = 0.015 for shannon
...
#   Invasive
model06.invasive <- model06.perm |> 
  filter(indicators == "Invasive") |> 
  ggplot(aes(x = mean_diff)) +
  geom_histogram(fill = "lightblue2", color = "black") +
  geom_vline(xintercept = model06.diff$obs_diff[model06.diff$indicators == "Invasive"],
             color = "red", linetype = "dashed", linewidth = 1) +
  labs(x = "Difference in means",
       y = "Frequency",
       title = "Invasive") +
...
grid.arrange(
  ...
  model06.shannon, model06.invasive,
  layout_matrix = rbind(
    c(1, 1, 1, 1, 1, 1),
    c(NA, 2, 2, 3, 3, NA),
    c(4, 4, 5, 5, 6, 6),
...
p_values07 <- model07.perm |>
  ...
  group_by(indicators) |>
  summarize(p_value = mean(abs(mean_diff) >= abs(obs_diff[1])))
p_values07 # p = 0.011 for perennial forb; p = 0.005 for perennial grass
#             p < 0.001 for shannon; p = 0.048 for invasive
...
#   Invasive
model07.invasive <- model07.perm |> 
  filter(indicators == "Invasive") |> 
  ggplot(aes(x = mean_diff)) +
  geom_histogram(fill = "lightblue2", color = "black") +
  geom_vline(xintercept = model07.diff$obs_diff[model07.diff$indicators == "Invasive"],
             color = "red", linetype = "dashed", linewidth = 1) +
  labs(x = "Difference in means",
       y = "Frequency",
       title = "Invasive (*)") +
...
grid.arrange(
  ...
  model07.shannon, model07.invasive,
  layout_matrix = rbind(
    c(1, 1, 1, 1, 1, 1),
    c(NA, 2, 2, 3, 3, NA),
    c(4, 4, 5, 5, 6, 6),
...
#   Invasive
model08.invasive <- model08.perm |> 
  filter(indicators == "Invasive") |> 
  ggplot(aes(x = mean_diff)) +
  geom_histogram(fill = "lightblue2", color = "black") +
  geom_vline(xintercept = model08.diff$obs_diff[model08.diff$indicators == "Invasive"],
             color = "red", linetype = "dashed", linewidth = 1) +
  labs(x = "Difference in means",
       y = "Frequency",
       title = "Invasive") +
...
grid.arrange(
  ...
  model08.shannon, model08.invasive,
  layout_matrix = rbind(
    c(1, 1, 1, 1, 1, 1),
    c(NA, 2, 2, 3, 3, NA),
    c(4, 4, 5, 5, 6, 6),
...
#             p < 0.001 for shannon; p = 0.009 for invasive
...
#   Invasive
model09.invasive <- model09.perm |> 
  filter(indicators == "Invasive") |> 
  ggplot(aes(x = mean_diff)) +
  geom_histogram(fill = "lightblue2", color = "black") +
  geom_vline(xintercept = model09.diff$obs_diff[model09.diff$indicators == "Invasive"],
             color = "red", linetype = "dashed", linewidth = 1) +
  labs(x = "Difference in means",
       y = "Frequency",
       title = "Invasive (**)") +
...
grid.arrange(
  ...
  model09.shannon, model09.invasive,
  layout_matrix = rbind(
    c(1, 1, 1, 1, 1, 1),
    c(NA, 2, 2, 3, 3, NA),
    c(4, 4, 5, 5, 6, 6),
...
p_values10 <- model10.perm |>
  ...
  group_by(indicators) |>
  summarize(p_value = mean(abs(mean_diff) >= abs(obs_diff[1])))
p_values10 # p = 0.03 for perennial grass
...
#   Invasive
model10.invasive <- model10.perm |> 
  filter(indicators == "Invasive") |> 
  ggplot(aes(x = mean_diff)) +
  geom_histogram(fill = "lightblue2", color = "black") +
  geom_vline(xintercept = model10.diff$obs_diff[model10.diff$indicators == "Invasive"],
             color = "red", linetype = "dashed", linewidth = 1) +
  labs(x = "Difference in means",
       y = "Frequency",
       title = "Invasive") +
...
grid.arrange(
  ...
  model10.shannon, model10.invasive,
  layout_matrix = rbind(
    c(1, 1, 1, 1, 1, 1),
    c(NA, 2, 2, 3, 3, NA),
    c(4, 4, 5, 5, 6, 6),
...
#   Invasive
model11.invasive <- model11.perm |> 
  filter(indicators == "Invasive") |> 
  ggplot(aes(x = mean_diff)) +
  geom_histogram(fill = "lightblue2", color = "black") +
  geom_vline(xintercept = model11.diff$obs_diff[model11.diff$indicators == "Invasive"],
             color = "red", linetype = "dashed", linewidth = 1) +
  labs(x = "Difference in means",
       y = "Frequency",
       title = "Invasive") +
...
grid.arrange(
  ...
  model11.shannon, model11.invasive,
  layout_matrix = rbind(
    c(1, 1, 1, 1, 1, 1),
    c(NA, 2, 2, 3, 3, NA),
    c(4, 4, 5, 5, 6, 6),
...
p_values12 <- model12.perm |>
  ...
  group_by(indicators) |>
  summarize(p_value = mean(abs(mean_diff) >= abs(obs_diff[1])))
p_values12 # p = 0.008 for annual grass; p < 0.001 for perennial grass, 
#     p = 0.02 for invasive
...
#   Invasive
model12.invasive <- model12.perm |> 
  filter(indicators == "Invasive") |> 
  ggplot(aes(x = mean_diff)) +
  geom_histogram(fill = "lightblue2", color = "black") +
  geom_vline(xintercept = model12.diff$obs_diff[model12.diff$indicators == "Invasive"],
             color = "red", linetype = "dashed", linewidth = 1) +
  labs(x = "Difference in means",
       y = "Frequency",
       title = "Invasive (*)") +
...
grid.arrange(
  ...
  model12.shannon, model12.invasive,
  layout_matrix = rbind(
    c(1, 1, 1, 1, 1, 1),
    c(NA, 2, 2, 3, 3, NA),
    c(4, 4, 5, 5, 6, 6),
...
p_values13 <- model13.perm |>
  ...
  group_by(indicators) |>
  summarize(p_value = mean(abs(mean_diff) >= abs(obs_diff[1])))
p_values13 # p = 0.0003 for perennial forb; p = 0.04 for shannon
...
#   Invasive
model13.invasive <- model13.perm |> 
  filter(indicators == "Invasive") |> 
  ggplot(aes(x = mean_diff)) +
  geom_histogram(fill = "lightblue2", color = "black") +
  geom_vline(xintercept = model13.diff$obs_diff[model13.diff$indicators == "Invasive"],
             color = "red", linetype = "dashed", linewidth = 1) +
  labs(x = "Difference in means",
       y = "Frequency",
       title = "Invasive") +
...
grid.arrange(
  ...
  model13.shannon, model13.invasive,
  layout_matrix = rbind(
    c(1, 1, 1, 1, 1, 1),
    c(NA, 2, 2, 3, 3, NA),
    c(4, 4, 5, 5, 6, 6),
...
p_values14 <- model14.perm |>
  ...
  group_by(indicators) |>
  summarize(p_value = mean(abs(mean_diff) >= abs(obs_diff[1])))
p_values14 # p = 0.046 for perennial forb
...
#   Invasive
model14.invasive <- model14.perm |> 
  filter(indicators == "Invasive") |> 
  ggplot(aes(x = mean_diff)) +
  geom_histogram(fill = "lightblue2", color = "black") +
  geom_vline(xintercept = model14.diff$obs_diff[model14.diff$indicators == "Invasive"],
             color = "red", linetype = "dashed", linewidth = 1) +
  labs(x = "Difference in means",
       y = "Frequency",
       title = "Invasive") +
...
grid.arrange(
  ...
  model14.shannon, model14.invasive,
  layout_matrix = rbind(
    c(1, 1, 1, 1, 1, 1),
    c(NA, 2, 2, 3, 3, NA),
    c(4, 4, 5, 5, 6, 6),
...
p_values15 <- model15.perm |>
  ...
  group_by(indicators) |>
  summarize(p_value = mean(abs(mean_diff) >= abs(obs_diff[1])))
p_values15 # p = 0.0011 for perennial grass; p = 0.014 for shannon
...
#   Invasive
model15.invasive <- model15.perm |> 
  filter(indicators == "Invasive") |> 
  ggplot(aes(x = mean_diff)) +
  geom_histogram(fill = "lightblue2", color = "black") +
  geom_vline(xintercept = model15.diff$obs_diff[model15.diff$indicators == "Invasive"],
             color = "red", linetype = "dashed", linewidth = 1) +
  labs(x = "Difference in means",
       y = "Frequency",
       title = "Invasive") +
...
grid.arrange(
  ...
  model15.shannon, model15.invasive,
  layout_matrix = rbind(
    c(1, 1, 1, 1, 1, 1),
    c(NA, 2, 2, 3, 3, NA),
    c(4, 4, 5, 5, 6, 6),
...
#   Invasive
model16.invasive <- model16.perm |> 
  filter(indicators == "Invasive") |> 
  ggplot(aes(x = mean_diff)) +
  geom_histogram(fill = "lightblue2", color = "black") +
  geom_vline(xintercept = model16.diff$obs_diff[model16.diff$indicators == "Invasive"],
             color = "red", linetype = "dashed", linewidth = 1) +
  labs(x = "Difference in means",
       y = "Frequency",
       title = "Invasive") +
...
grid.arrange(
  ...
  model16.shannon, model16.invasive,
  layout_matrix = rbind(
    c(1, 1, 1, 1, 1, 1),
    c(NA, 2, 2, 3, 3, NA),
    c(4, 4, 5, 5, 6, 6),
...
p_values17 <- model17.perm |>
  ...
  group_by(indicators) |>
  summarize(p_value = mean(abs(mean_diff) >= abs(obs_diff[1])))
p_values17 # p = 0.0016 for shannon
...
#   Invasive
model17.invasive <- model17.perm |> 
  filter(indicators == "Invasive") |> 
  ggplot(aes(x = mean_diff)) +
  geom_histogram(fill = "lightblue2", color = "black") +
  geom_vline(xintercept = model17.diff$obs_diff[model17.diff$indicators == "Invasive"],
             color = "red", linetype = "dashed", linewidth = 1) +
  labs(x = "Difference in means",
       y = "Frequency",
       title = "Invasive") +
...
grid.arrange(
  ...
  model17.shannon, model17.invasive,
  layout_matrix = rbind(
    c(1, 1, 1, 1, 1, 1),
    c(NA, 2, 2, 3, 3, NA),
    c(4, 4, 5, 5, 6, 6),
...
#   Invasive
model18.invasive <- model18.perm |> 
  filter(indicators == "Invasive") |> 
  ggplot(aes(x = mean_diff)) +
  geom_histogram(fill = "lightblue2", color = "black") +
  geom_vline(xintercept = model18.diff$obs_diff[model18.diff$indicators == "Invasive"],
             color = "red", linetype = "dashed", linewidth = 1) +
  labs(x = "Difference in means",
       y = "Frequency",
       title = "Invasive") +
...
grid.arrange(
  ...
  model18.shannon, model18.invasive,
  layout_matrix = rbind(
    c(1, 1, 1, 1, 1, 1),
    c(NA, 2, 2, 3, 3, NA),
    c(4, 4, 5, 5, 6, 6),
...
p_values19 <- model19.perm |>
  ...
  group_by(indicators) |>
  summarize(p_value = mean(abs(mean_diff) >= abs(obs_diff[1])))
p_values19 # p < 0.001 for annual and perennial grass and invasive; 
#   p = 0.03 for shannon
...
#   Invasive
model19.invasive <- model19.perm |> 
  filter(indicators == "Invasive") |> 
  ggplot(aes(x = mean_diff)) +
  geom_histogram(fill = "lightblue2", color = "black") +
  geom_vline(xintercept = model19.diff$obs_diff[model19.diff$indicators == "Invasive"],
             color = "red", linetype = "dashed", linewidth = 1) +
  labs(x = "Difference in means",
       y = "Frequency",
       title = "Invasive (***)") +
...
grid.arrange(
  ...
  model19.shannon, model19.invasive,
  layout_matrix = rbind(
    c(1, 1, 1, 1, 1, 1),
    c(NA, 2, 2, 3, 3, NA),
    c(4, 4, 5, 5, 6, 6),
...
p_values20 <- model20.perm |>
  ...
  group_by(indicators) |>
  summarize(p_value = mean(abs(mean_diff) >= abs(obs_diff[1])))
p_values20 # p = 0.0044 for perennial forb; p = 0.0048 for shannon
...
#   Invasive
model20.invasive <- model20.perm |> 
  filter(indicators == "Invasive") |> 
  ggplot(aes(x = mean_diff)) +
  geom_histogram(fill = "lightblue2", color = "black") +
  geom_vline(xintercept = model20.diff$obs_diff[model20.diff$indicators == "Invasive"],
             color = "red", linetype = "dashed", linewidth = 1) +
  labs(x = "Difference in means",
       y = "Frequency",
       title = "Invasive") +
...
grid.arrange(
  ...
  model20.shannon, model20.invasive,
  layout_matrix = rbind(
    c(1, 1, 1, 1, 1, 1),
    c(NA, 2, 2, 3, 3, NA),
    c(4, 4, 5, 5, 6, 6),
...
p_values21 <- model21.perm |>
  ...
  group_by(indicators) |>
  summarize(p_value = mean(abs(mean_diff) >= abs(obs_diff[1])))
p_values21 # p = 0.0011 for shannon
...
#   Invasive
model21.invasive <- model21.perm |> 
  filter(indicators == "Invasive") |> 
  ggplot(aes(x = mean_diff)) +
  geom_histogram(fill = "lightblue2", color = "black") +
  geom_vline(xintercept = model21.diff$obs_diff[model21.diff$indicators == "Invasive"],
             color = "red", linetype = "dashed", linewidth = 1) +
  labs(x = "Difference in means",
       y = "Frequency",
       title = "Invasive") +
...
grid.arrange(
  ...
  model21.shannon, model21.invasive,
  layout_matrix = rbind(
    c(1, 1, 1, 1, 1, 1),
    c(NA, 2, 2, 3, 3, NA),
    c(4, 4, 5, 5, 6, 6),
...
p_values22 <- model22.perm |>
  ...
  group_by(indicators) |>
  summarize(p_value = mean(abs(mean_diff) >= abs(obs_diff[1])))
p_values22 # p = 0.047 for annual grass; p = 0.03 for shannon
...
#   Invasive
model22.invasive <- model22.perm |> 
  filter(indicators == "Invasive") |> 
  ggplot(aes(x = mean_diff)) +
  geom_histogram(fill = "lightblue2", color = "black") +
  geom_vline(xintercept = model22.diff$obs_diff[model22.diff$indicators == "Invasive"],
             color = "red", linetype = "dashed", linewidth = 1) +
  labs(x = "Difference in means",
       y = "Frequency",
       title = "Invasive") +
...
grid.arrange(
  ...
  model22.shannon, model22.invasive,
  layout_matrix = rbind(
    c(1, 1, 1, 1, 1, 1),
    c(NA, 2, 2, 3, 3, NA),
    c(4, 4, 5, 5, 6, 6),
...
p_values23 <- model23.perm |>
  ...
  group_by(indicators) |>
  summarize(p_value = mean(abs(mean_diff) >= abs(obs_diff[1])))
p_values23 # p = 0.02 for perennial grass
...
#   Invasive
model23.invasive <- model23.perm |> 
  filter(indicators == "Invasive") |> 
  ggplot(aes(x = mean_diff)) +
  geom_histogram(fill = "lightblue2", color = "black") +
  geom_vline(xintercept = model23.diff$obs_diff[model23.diff$indicators == "Invasive"],
             color = "red", linetype = "dashed", linewidth = 1) +
  labs(x = "Difference in means",
       y = "Frequency",
       title = "Invasive") +
...
grid.arrange(
  ...
  model23.shannon, model23.invasive,
  layout_matrix = rbind(
    c(1, 1, 1, 1, 1, 1),
    c(NA, 2, 2, 3, 3, NA),
    c(4, 4, 5, 5, 6, 6),
...
#   Invasive
model24.invasive <- model24.perm |> 
  filter(indicators == "Invasive") |> 
  ggplot(aes(x = mean_diff)) +
  geom_histogram(fill = "lightblue2", color = "black") +
  geom_vline(xintercept = model24.diff$obs_diff[model24.diff$indicators == "Invasive"],
             color = "red", linetype = "dashed", linewidth = 1) +
  labs(x = "Difference in means",
       y = "Frequency",
       title = "Invasive") +
...
grid.arrange(
  ...
  model24.shannon, model24.invasive,
  layout_matrix = rbind(
    c(1, 1, 1, 1, 1, 1),
    c(NA, 2, 2, 3, 3, NA),
    c(4, 4, 5, 5, 6, 6),
...
p_values25 <- model25.perm |>
  ...
  group_by(indicators) |>
  summarize(p_value = mean(abs(mean_diff) >= abs(obs_diff[1])))
p_values25 # p = 0.012 for shannon
...
#   Invasive
model25.invasive <- model25.perm |> 
  filter(indicators == "Invasive") |> 
  ggplot(aes(x = mean_diff)) +
  geom_histogram(fill = "lightblue2", color = "black") +
  geom_vline(xintercept = model25.diff$obs_diff[model25.diff$indicators == "Invasive"],
             color = "red", linetype = "dashed", linewidth = 1) +
  labs(x = "Difference in means",
       y = "Frequency",
       title = "Invasive") +
...
grid.arrange(
  ...
  model25.shannon, model25.invasive,
  layout_matrix = rbind(
    c(1, 1, 1, 1, 1, 1),
    c(NA, 2, 2, 3, 3, NA),
    c(4, 4, 5, 5, 6, 6),
...
p_values26 <- model26.perm |>
  ...
  group_by(indicators) |>
  summarize(p_value = mean(abs(mean_diff) >= abs(obs_diff[1])))
p_values26 # p = 0.0004 for perennial forb and shannon
...
#   Invasive
model26.invasive <- model26.perm |> 
  filter(indicators == "Invasive") |> 
  ggplot(aes(x = mean_diff)) +
  geom_histogram(fill = "lightblue2", color = "black") +
  geom_vline(xintercept = model26.diff$obs_diff[model26.diff$indicators == "Invasive"],
             color = "red", linetype = "dashed", linewidth = 1) +
  labs(x = "Difference in means",
       y = "Frequency",
       title = "Invasive") +
...
grid.arrange(
  ...
  model26.shannon, model26.invasive,
  layout_matrix = rbind(
    c(1, 1, 1, 1, 1, 1),
    c(NA, 2, 2, 3, 3, NA),
    c(4, 4, 5, 5, 6, 6),
...
#   Invasive
model27.invasive <- model27.perm |> 
  filter(indicators == "Invasive") |> 
  ggplot(aes(x = mean_diff)) +
  geom_histogram(fill = "lightblue2", color = "black") +
  geom_vline(xintercept = model27.diff$obs_diff[model27.diff$indicators == "Invasive"],
             color = "red", linetype = "dashed", linewidth = 1) +
  labs(x = "Difference in means",
       y = "Frequency",
       title = "Invasive") +
...
grid.arrange(
  ...
  model27.shannon, model27.invasive,
  layout_matrix = rbind(
    c(1, 1, 1, 1, 1, 1),
    c(NA, 2, 2, 3, 3, NA),
    c(4, 4, 5, 5, 6, 6),
...
#   Invasive
model28.invasive <- model28.perm |> 
  filter(indicators == "Invasive") |> 
  ggplot(aes(x = mean_diff)) +
  geom_histogram(fill = "lightblue2", color = "black") +
  geom_vline(xintercept = model28.diff$obs_diff[model28.diff$indicators == "Invasive"],
             color = "red", linetype = "dashed", linewidth = 1) +
  labs(x = "Difference in means",
       y = "Frequency",
       title = "Invasive") +
...
grid.arrange(
  ...
  model28.shannon, model28.invasive,
  layout_matrix = rbind(
    c(1, 1, 1, 1, 1, 1),
    c(NA, 2, 2, 3, 3, NA),
    c(4, 4, 5, 5, 6, 6),
...
p_values29 <- model29.perm |>
  ...
  group_by(indicators) |>
  summarize(p_value = mean(abs(mean_diff) >= abs(obs_diff[1])))
p_values29 # p = 0.04 for perennial grass
...
#   Invasive
model29.invasive <- model29.perm |> 
  filter(indicators == "Invasive") |> 
  ggplot(aes(x = mean_diff)) +
  geom_histogram(fill = "lightblue2", color = "black") +
  geom_vline(xintercept = model29.diff$obs_diff[model29.diff$indicators == "Invasive"],
             color = "red", linetype = "dashed", linewidth = 1) +
  labs(x = "Difference in means",
       y = "Frequency",
       title = "Invasive") +
...
grid.arrange(
  ...
  model29.shannon, model29.invasive,
  layout_matrix = rbind(
    c(1, 1, 1, 1, 1, 1),
    c(NA, 2, 2, 3, 3, NA),
    c(4, 4, 5, 5, 6, 6),
...
#   Invasive
model30.invasive <- model30.perm |> 
  filter(indicators == "Invasive") |> 
  ggplot(aes(x = mean_diff)) +
  geom_histogram(fill = "lightblue2", color = "black") +
  geom_vline(xintercept = model30.diff$obs_diff[model30.diff$indicators == "Invasive"],
             color = "red", linetype = "dashed", linewidth = 1) +
  labs(x = "Difference in means",
       y = "Frequency",
       title = "Invasive") +
...
grid.arrange(
  ...
  model30.shannon, model30.invasive,
  layout_matrix = rbind(
    c(1, 1, 1, 1, 1, 1),
    c(NA, 2, 2, 3, 3, NA),
    c(4, 4, 5, 5, 6, 6),
...
p_values31 <- model31.perm |>
  ...
  group_by(indicators) |>
  summarize(p_value = mean(abs(mean_diff) >= abs(obs_diff[1])))
p_values31 # p = 0.003 for shannon
...
#   Invasive
model31.invasive <- model31.perm |> 
  filter(indicators == "Invasive") |> 
  ggplot(aes(x = mean_diff)) +
  geom_histogram(fill = "lightblue2", color = "black") +
  geom_vline(xintercept = model31.diff$obs_diff[model31.diff$indicators == "Invasive"],
             color = "red", linetype = "dashed", linewidth = 1) +
  labs(x = "Difference in means",
       y = "Frequency",
       title = "Invasive") +
...
grid.arrange(
  ...
  model31.shannon, model31.invasive,
  layout_matrix = rbind(
    c(1, 1, 1, 1, 1, 1),
    c(NA, 2, 2, 3, 3, NA),
    c(4, 4, 5, 5, 6, 6),
...
p_values32 <- model32.perm |>
  ...
  group_by(indicators) |>
  summarize(p_value = mean(abs(mean_diff) >= abs(obs_diff[1])))
p_values32 # p = 0.03 for invasive
...
#   Invasive
model32.invasive <- model32.perm |> 
  filter(indicators == "Invasive") |> 
  ggplot(aes(x = mean_diff)) +
  geom_histogram(fill = "lightblue2", color = "black") +
  geom_vline(xintercept = model32.diff$obs_diff[model32.diff$indicators == "Invasive"],
             color = "red", linetype = "dashed", linewidth = 1) +
  labs(x = "Difference in means",
       y = "Frequency",
       title = "Invasive (*)") +
...
grid.arrange(
  ...
  model32.shannon, model32.invasive,
  layout_matrix = rbind(
    c(1, 1, 1, 1, 1, 1),
    c(NA, 2, 2, 3, 3, NA),
    c(4, 4, 5, 5, 6, 6),
...
p_values33 <- model33.perm |>
  ...
  group_by(indicators) |>
  summarize(p_value = mean(abs(mean_diff) >= abs(obs_diff[1])))
p_values33 # p = 0.04 for invasive
...
#   Invasive
model33.invasive <- model33.perm |> 
  filter(indicators == "Invasive") |> 
  ggplot(aes(x = mean_diff)) +
  geom_histogram(fill = "lightblue2", color = "black") +
  geom_vline(xintercept = model33.diff$obs_diff[model33.diff$indicators == "Invasive"],
             color = "red", linetype = "dashed", linewidth = 1) +
  labs(x = "Difference in means",
       y = "Frequency",
       title = "Invasive (*)") +
...
grid.arrange(
  ...
  model33.shannon, model33.invasive,
  layout_matrix = rbind(
    c(1, 1, 1, 1, 1, 1),
    c(NA, 2, 2, 3, 3, NA),
    c(4, 4, 5, 5, 6, 6),
...
#   Invasive
model34.invasive <- model34.perm |> 
  filter(indicators == "Invasive") |> 
  ggplot(aes(x = mean_diff)) +
  geom_histogram(fill = "lightblue2", color = "black") +
  geom_vline(xintercept = model34.diff$obs_diff[model34.diff$indicators == "Invasive"],
             color = "red", linetype = "dashed", linewidth = 1) +
  labs(x = "Difference in means",
       y = "Frequency",
       title = "Invasive") +
...
grid.arrange(
  ...
  model34.shannon, model34.invasive,
  layout_matrix = rbind(
    c(1, 1, 1, 1, 1, 1),
    c(NA, 2, 2, 3, 3, NA),
    c(4, 4, 5, 5, 6, 6),
...
#   Invasive
model35.invasive <- model35.perm |> 
  filter(indicators == "Invasive") |> 
  ggplot(aes(x = mean_diff)) +
  geom_histogram(fill = "lightblue2", color = "black") +
  geom_vline(xintercept = model35.diff$obs_diff[model35.diff$indicators == "Invasive"],
             color = "red", linetype = "dashed", linewidth = 1) +
  labs(x = "Difference in means",
       y = "Frequency",
       title = "Invasive (*)") +
...
grid.arrange(
  ...
  model35.shannon, model35.invasive,
  layout_matrix = rbind(
    c(1, 1, 1, 1, 1, 1),
    c(NA, 2, 2, 3, 3, NA),
    c(4, 4, 5, 5, 6, 6),
...
#   Invasive
model36.invasive <- model36.perm |> 
  filter(indicators == "Invasive") |> 
  ggplot(aes(x = mean_diff)) +
  geom_histogram(fill = "lightblue2", color = "black") +
  geom_vline(xintercept = model36.diff$obs_diff[model36.diff$indicators == "Invasive"],
             color = "red", linetype = "dashed", linewidth = 1) +
  labs(x = "Difference in means",
       y = "Frequency",
       title = "Invasive") +
...
grid.arrange(
  ...
  model36.shannon, model36.invasive,
  layout_matrix = rbind(
    c(1, 1, 1, 1, 1, 1),
    c(NA, 2, 2, 3, 3, NA),
    c(4, 4, 5, 5, 6, 6),
...
#   Invasive
model37.invasive <- model37.perm |> 
  filter(indicators == "Invasive") |> 
  ggplot(aes(x = mean_diff)) +
  geom_histogram(fill = "lightblue2", color = "black") +
  geom_vline(xintercept = model37.diff$obs_diff[model37.diff$indicators == "Invasive"],
             color = "red", linetype = "dashed", linewidth = 1) +
  labs(x = "Difference in means",
       y = "Frequency",
       title = "Invasive") +
...
grid.arrange(
  ...
  model37.shannon, model37.invasive,
  layout_matrix = rbind(
    c(1, 1, 1, 1, 1, 1),
    c(NA, 2, 2, 3, 3, NA),
    c(4, 4, 5, 5, 6, 6),
...
#   Invasive
model38.invasive <- model38.perm |> 
  filter(indicators == "Invasive") |> 
  ggplot(aes(x = mean_diff)) +
  geom_histogram(fill = "lightblue2", color = "black") +
  geom_vline(xintercept = model38.diff$obs_diff[model38.diff$indicators == "Invasive"],
             color = "red", linetype = "dashed", linewidth = 1) +
  labs(x = "Difference in means",
       y = "Frequency",
       title = "Invasive (*)") +
...
grid.arrange(
  ...
  model38.shannon, model38.invasive,
  layout_matrix = rbind(
    c(1, 1, 1, 1, 1, 1),
    c(NA, 2, 2, 3, 3, NA),
    c(4, 4, 5, 5, 6, 6),
...
#   Invasive
model39.invasive <- model39.perm |> 
  filter(indicators == "Invasive") |> 
  ggplot(aes(x = mean_diff)) +
  geom_histogram(fill = "lightblue2", color = "black") +
  geom_vline(xintercept = model39.diff$obs_diff[model39.diff$indicators == "Invasive"],
             color = "red", linetype = "dashed", linewidth = 1) +
  labs(x = "Difference in means",
       y = "Frequency",
       title = "Invasive") +
...
grid.arrange(
  ...
  model39.shannon, model39.invasive,
  layout_matrix = rbind(
    c(1, 1, 1, 1, 1, 1),
    c(NA, 2, 2, 3, 3, NA),
    c(4, 4, 5, 5, 6, 6),
...
#   Invasive
model40.invasive <- model40.perm |> 
  filter(indicators == "Invasive") |> 
  ggplot(aes(x = mean_diff)) +
  geom_histogram(fill = "lightblue2", color = "black") +
  geom_vline(xintercept = model40.diff$obs_diff[model40.diff$indicators == "Invasive"],
             color = "red", linetype = "dashed", linewidth = 1) +
  labs(x = "Difference in means",
       y = "Frequency",
       title = "Invasive") +
...
grid.arrange(
  ...
  model40.shannon, model40.invasive,
  layout_matrix = rbind(
    c(1, 1, 1, 1, 1, 1),
    c(NA, 2, 2, 3, 3, NA),
    c(4, 4, 5, 5, 6, 6),
...
#   Prosopis glandulosa
model41.prgl2 <- model41.perm |> 
  filter(indicators == "Prosopis glandulosa") |> 
  ggplot(aes(x = mean_diff)) +
  geom_histogram(fill = "lightblue2", color = "black") +
  geom_vline(xintercept = model41.diff$obs_diff[model41.diff$indicators == "Prosopis glandulosa"],
             color = "red", linetype = "dashed", linewidth = 1) +
  labs(x = "Difference in means",
       y = "Frequency",
...
p_values42 <- model42.perm |>
  ...
  group_by(indicators) |>
  summarize(p_value = mean(abs(mean_diff) >= abs(obs_diff[1])))
p_values42 # p = 0.04 for perennial forb; p = 0.03 for shannon
...
#   Invasive
model42.invasive <- model42.perm |> 
  filter(indicators == "Invasive") |> 
  ggplot(aes(x = mean_diff)) +
  geom_histogram(fill = "lightblue2", color = "black") +
  geom_vline(xintercept = model42.diff$obs_diff[model42.diff$indicators == "Invasive"],
             color = "red", linetype = "dashed", linewidth = 1) +
  labs(x = "Difference in means",
       y = "Frequency",
       title = expression(italic("Invasive"))) +
  theme_bw(base_size = 10) +
  theme(plot.margin = margin(10, 10, 10, 10))
model42.invasive
...
grid.arrange(
  ...
  model42.shannon, model42.invasive,
  layout_matrix = rbind(
    c(1, 1, 1, 1, 1, 1),
    c(NA, 2, 2, 3, 3, NA),
    c(4, 4, 5, 5, 6, 6),
...
tiff("figures/2026-06_PSM-and-permutation-tests/model08_permutation.tiff",
     units = "in", width = 08, height = 9, res = 150)
grid.arrange(
  model08.bp, model08.annforb, model08.anngrass,
  model08.perforb, model08.pergrass, model08.shrub,
  model08.shannon, model08.invasive,
...
# 09. Snake River Plain: Post-burn closure
...
grid.arrange(
  model41.bp, model41.annforb, model41.anngrass,
  model41.perforb, model41.pergrass, model41.shrub,
  model41.shannon, model41.invasive,
  layout_matrix = rbind(
    c(1, 1, 1, 1, 1, 1),
    c(NA, 2, 2, 3, 3, NA),
    c(4, 4, 5, 5, 6, 6),
...
tiff("figures/2026-06_PSM-and-permutation-tests/model43_permutation.tiff",
     units = "in", width = 10, height = 9, res = 150)
grid.arrange(
  model43.bp, model43.annforb, model43.anngrass,
  model43.perforb, model43.pergrass, model43.shrub,
  model43.shannon, model43.invasive,
  layout_matrix = rbind(
    c(1, 1, 1, 1, 1, 1),
    c(NA, 2, 2, 3, 3, NA),
    c(4, 4, 5, 5, 6, 6),
...
tiff("figures/2026-06_PSM-and-permutation-tests/model44_permutation.tiff",
     units = "in", width = 10, height = 9, res = 150)
grid.arrange(
  model44.bp, model44.annforb, model44.anngrass,
  model44.perforb, model44.pergrass, model44.shrub,
  model44.shannon, model44.invasive,
  layout_matrix = rbind(
    c(1, 1, 1, 1, 1, 1),
    c(NA, 2, 2, 3, 3, NA),
    c(4, 4, 5, 5, 6, 6),
...
tiff("figures/2026-06_PSM-and-permutation-tests/model45_permutation.tiff",
     units = "in", width = 10, height = 9, res = 150)
grid.arrange(
...
tiff("figures/2026-06_PSM-and-permutation-tests/model46_permutation.tiff",
     units = "in", width = 10, height = 9, res = 150)
grid.arrange(
  model46.bp, model46.annforb, model46.anngrass,
  model46.perforb, model46.pergrass, model46.shrub,
  model46.shannon, model46.invasive,
  layout_matrix = rbind(
    c(1, 1, 1, 1, 1, 1),
    c(NA, 2, 2, 3, 3, NA),
    c(4, 4, 5, 5, 6, 6),
