...
#   based on treatment info v008.

# Difference with 07.3.R:
#   No TrtPolyID or FirePolyID lists are saved.
...
treatment.info.008 <- read_csv("data/versions-from-R/11.1_Treatment-info_v008.csv")


# LDC cols alone ----------------------------------------------------------

ldc <- treatment.info.008 |>
...
write_csv(ldc.008,
          file = "data/versions-from-R/11.2_LDC-points_v008.csv",
          na = ""
)


save.image("RData/07.3_assign-land-history_v008.RData")
